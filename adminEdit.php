...
?>
<div class="main-body">
<h2 class="page-heading">Edit Content</h2>
		...
		<div class="featurette-login">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="bulletins">
					...
					<input type="hidden" name="bulletinMode" value="edit">
					<div class="form-group">
						<label for="inputSelectServiceBulletinEdit" class="control-label col-xs-2">Select Service</label>
						<div class="col-xs-5">
							<select name="service-info-bulletin" class="form-control" id="inputSelectServiceBulletinEdit">
							<?php 
					...
					<input type="submit" id="sendBulletinInfo" value="Save Bulletin" class="btn btn-primary">
				...
				<div class="tab-pane" id="sermons">
					...
					<input type="hidden" name="sermonMode" value="edit">
					<div class="form-group">
						<label for="inputSelectServiceEdit" class="control-label col-xs-2">Select Service</label>
						<div class="col-xs-5">
							<select name="service-info" class="form-control" id="inputSelectServiceEdit">
							<?php 
								$result = mysql_query("SELECT service_id, serviceDay, serviceMonth, serviceYear
													   FROM services");
					...
					<input type="submit" id="sendSermonInfo" value="Save Sermon" class="btn btn-primary">
					</div>
					</form>
				</div>
